...
Lütfen kimlik doğrulama uygulamanız tarafından sağlanan kimlik doğrulama kodunu girerek hesabınıza erişimi onaylayın.            </template>

            <template v-else>
Lütfen acil durum kurtarma kodlarınızdan birini girerek hesabınıza erişimi onaylayın.            </template>
        </div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                <button type="button" class="text-sm text-gray-600 hover:text-gray-900 underline cursor-pointer" @click.prevent="toggleRecovery">
                    <template v-if="! recovery">
                 Kurtarma kodu kullanın
                    </template>

                    <template v-else>
                  
Bir kimlik doğrulama kodu kullanın
                    </template>
                </button>
