    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Bursluluk</h1>
                <hr class="mb-4">
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-4">
                        <h3 class="section-title">Bursluluk Başvurusu</h3>
                        <div class="section-intro">Bursluluk Başvurusunu Düzenleyin<a href="{{ route('admin.help') }}"><br>
                                Daha
                                Fazla Öğren</a></div>
                    </div>
                            ...
                            @if (Session::has('message'))
                                <div class="alert alert-success">
                                    <strong>{{ Session::get('message') }}</strong> <a style="color: red"
                                        href="{{ route('admin.bursluluk') }}">  Görüntüle!</a>
                                </div>
                            @endif
                            <div class="app-card-body">
                                <form wire:submit.prevent="updateCategory()">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" wire:model="url"
                                            required>
                                        <div> @error('title')
                                                {{ $message }}
                                            @enderror </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="setting-input-3" class="form-label">Durum</label>:
