    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
                ...
                <div class="col-auto">						    
                    <a class="btn app-btn-primary" href="{{route('admin.category.social.add')}}">
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											...
											<tr>
												...
												<td class="cell"><a class="btn-sm app-btn-secondary" href="{{route('admin.category.social.edit' , ['category_id' => $cat->id])}}">Düzenle
