        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Eğitim Birimi Yönetimi</h1>
                    </div>
                ...
                <div class="col-auto">
                    <a class="btn app-btn-primary" href="{{ route('admin.units.add') }}">

                        Eğtim Birimine Yeni Ekle
                    </a>
                </div>
                                            ...
                                            @foreach ($unit as $b)
                                                <tr>
                                                    ...
                                                    <td class="cell"><img width="150px"
                                                            src="{{ asset('storage/units') }}/{{ $b->image }}"
                                                            alt="{{ $b->title }}"></td>
                                                    ...
                                                    <td class="cell"><a class="btn-sm app-btn-secondary"
                                                            href="{{ route('admin.units.edit', ['blog_id' => $b->id]) }}">Düzenle
