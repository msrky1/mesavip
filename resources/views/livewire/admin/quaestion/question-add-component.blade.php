    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Sık Sorulan Sorular</h1>
                <hr class="mb-4">
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-4">
                        <h3 class="section-title">Soru ve Cevap Ekleyin</h3>
                        <div class="section-intro">Soru ve cevap eklemek için formu eksiksiz doldurun<a href="{{ route('admin.help') }}"><br>
                                Daha
                                Fazla Öğren</a></div>
                    </div>
                            ...
                            @if (Session::has('message'))
                                <div class="alert alert-success">
                                    <strong>{{ Session::get('message') }}</strong> <a style="color: red"
                                        href="{{ route('admin.question') }}">Soru ve Cevapları Görüntüle</a>
                                </div>
                            @endif
                            <div class="app-card-body">
                                <form wire:submit.prevent="addQuestion()">
                                    <div class="mb-3">
                                        ...
                                        @csrf
                                        <label for="setting-input-2" class="form-label">Soru </label>:
                                    ...
                                    <div class="mb-3">
                                        <label for="setting-input-2" class="form-label">Cevap </label>:
                                        <input type="text" name="description" class="form-control" id="setting-input-2"
