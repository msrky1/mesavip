            ...
            <div class="container-xl">
                ...
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-4">
                        ...
                        <div class="section-intro">Web Sitesi Genel Ayarlar<a href="{{ route('admin.help') }}"><br>
                                Daha
                                Fazla Öğren</a></div>
                    </div>
                                ...
                                <form class="settings-form">
                                    <div class="mb-3">
                                        ...
                                        @foreach ($settings as $s)
                                            ...
                                            <div class="mb-3">
                                                <label for="setting-input-3" class="form-label">WhatsApp
                                                    Numarası</label>:
                                                    <br>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img width="200px" src="{{ asset('storage/image') }}/{{$s->image}}"
                                                    alt="logo">
                                            </div>


                                           <a href="{{ route('admin.setting.edit', ['setting_id' => $s->id ]) }}"><input type="button" class="btn btn-primary" value="Düzenle"></a> 
                                </form>
                            </div>
                            <!--//app-card-body-->
