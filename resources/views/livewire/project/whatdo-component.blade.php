                    ...
                    <div class="post-item">
                        <div class="post-inner">
                            <div class="post-thumb">
                                <a href="{{route('whatdo.detail' , [ $item->slug ])}}"><img src="{{asset('storage/whatdoing')}}/{{$item->image}}" alt="{{$item->title}}"></a>
                            </div>
                            ...
                            <div class="post-footer">
                                <div class="pf-left">
                                    <a href="{{route('whatdo.detail' , [$item->slug])}}" class="lab-btn-text">Detay<i class="icofont-external-link"></i></a>
                                </div>
                                {{-- <div class="pf-right">
